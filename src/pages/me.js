    ...
    <Layout> 
      ...
      <div className="container">
        <div className="hero-wrapper">
          <Hero  index> <h1> <Typewriter text="About Me" /></h1>
      ...
      <div className="container">
        <div className="about-wrapper">
          ...
          <div className='about'><h1> Back Story.</h1>
          
            </div>
            <div className='about'>
            <p className="subtitle">
            Even as young as 13, I knew that my career lay in the technology industry. While growing up me and my friends were obsessed with video games, although rather than just playing them, we wanted to understand how they were made and create our own. What started with a couple of websites and engines that let you create your own games, eventually lead us to writing our first programs in Java and brainstorming and RPG text-based adventure.  This was the spark the led me to where I am today, as since then, I've continued the interest in technology, constantly pushing my knowledge to greater heights. Although even at the start of my journey I recognize that greater minds than I have paved the way for me. After all, it was my friend's idea to start coding, and my friends who taught my system administration with all the ins and outs of how to host and administer video game servers.  
            <br/> <br/>
            One quote that has always resonated with me is Isaac Newton's "If I have seen further, it is only because I have stood on the shoulders of giants." This quote speaks to the beginning of my career journey, starting as a high schooler in the help desk department. It was there that I was fortunate enough to have a mentor who taught me about networking and software development. I spent two and a half years at the help desk, and the relationships I formed during that time ultimately led to a recommendation from my mentor that helped me secure my first “entry” level technical position at a ClearSKY Systems, Inc. 
            <br/> <br/>
            After signing onto ClearSKY, I also signed onto to pursue night school to continue my education and achieve my Bachelor’s in Information Technology at Lewis University while working full time. While I knew it would be a challenge, I also knew that it would be something I would never regret. While working at ClearSKY, it taught me what it took to be a good Engineer, it's essential to understand that the internet never sleeps, and neither can you. This means being willing to tackle any challenge that comes your way, no matter how difficult or time-consuming it may be. Whether it be performing disaster recovery in the twilight hours of the morning, digging deep into the bits and bytes of packets captures, or spending hours to automate a job that takes minutes to do manually. Ultimately, as a Network Engineer, you do whatever it takes to keep the network operational and running smoothly, it's just what we do. 
            <br/> <br/>
            Throughout my career so far, I've performed various roles in the technology industry that have provided me with valuable lessons and experiences. However, a burning question that always persists within me is: how does it work, and can it be done better?  
            <br/> <br/>
